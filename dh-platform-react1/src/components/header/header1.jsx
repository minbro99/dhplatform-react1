...
//           <img src="/src/assets/icons/home-energy-management_001.svg" alt="에너지 관리" className="w-10 h-10" />
//           <div className="flex flex-col">
//             <h1 className="text-2xl font-bold leading-tight text-center" style={{ color: '#6DC184' }}>아파트</h1>
//             <p className="text-sm" style={{ color: '#6DC184' }}>에너지 관리 플랫폼</p>
//           </div>
//         </div>
